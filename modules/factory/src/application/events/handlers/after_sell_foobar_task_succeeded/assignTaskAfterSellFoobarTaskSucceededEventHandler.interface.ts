...
import type { SellFoobarTaskSucceeded } from '../../sellFoobarTaskSucceeded.event';
import { SellFoobarTaskSucceededEventHandler } from '../sellFoobarTaskSucceededEventHandler.interface';
...
implements InputPortFactory<AssignTaskInputPort, SellFoobarTaskSucceeded> {
  // eslint-disable-next-line class-methods-use-this
  fromIntegrationEvent(event: SellFoobarTaskSucceeded): AssignTaskInputPort {
    const {
...
export abstract class AssignTaskAfterSellFoobarTaskSucceededEventHandler extends SellFoobarTaskSucceededEventHandler<
AssignTaskInput,
AssignTaskUseCase
> {
