...
import type {
  MineFooTaskInput,
  MineFooTaskInputPort,
} from '../../../ports/mineFooTaskInputPort.interface';
import { MineFooTaskUseCase } from '../../../use_cases/mineFooTask.useCase';
...
class InputPortImpl implements MineFooTaskInputPort {
...
implements
    InputPortFactory<MineFooTaskInputPort, MoveRobotToWorkstationSucceeded> {
...
export abstract class MineFooTaskAfterMoveRobotToWorkstationSucceededEventHandler extends MoveRobotToWorkstationSucceededEventHandler<
MineFooTaskInput,
MineFooTaskUseCase
> {
  constructor(useCase: MineFooTaskUseCase) {
          ...
          if (assignedTask && event.data.taskId) {
            ...
            if (optionalTask.isPresent) {
              ...
              return (
                ...
                && assignedTask.hasName(TaskName.MINE_FOO)
              );
            }
          }
        }
